...
Route::get('/pppp', [ChatController::class, 'index1'])->name('ChatController');
...
Route::GET('/chat-designation', [ChatController::class, 'chatdesignation'])->name('ChatController-chatdesignation');
Route::GET('/chat-groupdesignation', [ChatController::class, 'chatgroupdesignation'])->name('ChatController-chatdesignation');
...
// Route::get('/check-reload-status', [ChatController::class, 'checkReloadStatus']);



// Route::get('/clear-session', function (Request $request) {
//     // Forget specific session keys
//     $request->session()->forget(['firstReloadDone', 'secondReloadDone']);
